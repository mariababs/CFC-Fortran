PROGRAM ParabolaFlow
    ...
    !***************************************************
        ...
        call PsiCalc(Nx,My,Kappa2,KappaA,dxx,Psi,Omega,kPsi,DM2,Tol,dyy)
    ...
    !$OMP DO
        ...
        if ((j.gt.2).and.(j.lt.(My+1))) then
            Omega(i,j) = Omega(i,j) -Cy/DM2(i,j) * (Compositev(i,j-2) - 8*Compositev(i,j-1) + 8*Compositev(i,j+1) - &
    ...
    !************************************************************************
        subroutine PsiCalc(Nx,My,Kappa2,KappaA,dxx,Psi,Omega,kPsi,DM2,Tol,dyy)
    ...
    do i = 3,Nx
        do j = 3,My
        ! bulk
            Psi(i,j) = 0.4*(dxx+dyy)*Omega(i,j)*DM2(i,j) + &
            (-0.4*(dxx+dyy)/dxx)*(1.0/12*Psi0(i-2,j)-4.0/3*Psi0(i-1,j)-4.0/3*Psi0(i+1,j)+1.0/12*Psi0(i+2,j)) + &
            (-0.4*(dxx+dyy)/dyy)*(1.0/12*Psi0(i,j-2)-4.0/3*Psi0(i,j-1)-4.0/3*Psi0(i,j+1)+1.0/12*Psi0(i,j+2))
    ...
    !$OMP DO
        ...
        i = 2
        do j = 3,My
            Psi(i,j) = -6*(dxx*dyy)/(-10*dyy-15*dxx)*Omega(i,j)*DM2(i,j) + &
            6*dyy/(-10*dyy-15*dxx)*(-11.0/12*Psi0(i-1,j)-0.5*Psi0(i+1,j)-1.0/3*Psi0(i+2,j)+1.0/12*Psi0(i+3,j)) + &
            6*dxx/(-10*dyy-15*dxx)*(1.0/12*Psi0(i,j-2)-4.0/3*Psi0(i,j-1)-4.0/3*Psi0(i,j+1)+1.0/12*Psi0(i,j+2))
    ...
    !$OMP DO
        ...
        do j = 3,My
            Psi(i,j) = -6*(dxx*dyy)/(-10*dyy-15*dxx)*Omega(i,j)*DM2(i,j) + &
            6*dyy/(-10*dyy-15*dxx)*(1.0/12*Psi0(i-3,j)-1.0/3*Psi0(i-2,j)-0.5*Psi0(i-1,j)-11.0/12*Psi0(i+1,j)) + &
            6*dxx/(-10*dyy-15*dxx)*(1.0/12*Psi0(i,j-2)-4.0/3*Psi0(i,j-1)-4.0/3*Psi0(i,j+1)+1.0/12*Psi0(i,j+2))
    ...
    !$OMP DO
        ...
        j = 2
        do i = 3,Nx
            Psi(i,j) = -6*(dxx*dyy)/(-15*dyy-10*dxx)*Omega(i,j)*DM2(i,j) + &
            6*(dyy)/(-15*dyy-10*dxx)*(1.0/12*Psi0(i-2,j)-4.0/3*Psi0(i-1,j)-4.0/3*Psi0(i+1,j)+1.0/12*Psi0(i+2,j)) + &
            6*(dxx)/(-15*dyy-10*dxx)*(-11.0/12*Psi0(i,j-1)-0.5*Psi0(i,j+1)-1.0/3*Psi0(i,j+2)+1.0/12*Psi0(i,j+3))
    ...
    !$OMP DO
        ...
        do i = 3,Nx
            Psi(i,j) = -6*(dxx*dyy)/(-15*dyy-10*dxx)*Omega(i,j)*DM2(i,j) + &
            6*(dyy)/(-15*dyy-10*dxx)*(1.0/12*Psi0(i-2,j)-4.0/3*Psi0(i-1,j)-4.0/3*Psi0(i+1,j)+1.0/12*Psi0(i+2,j)) + &
            6*(dxx)/(-15*dyy-10*dxx)*(1.0/12*Psi0(i,j-3)-1.0/3*Psi0(i,j-2)-0.5*Psi0(i,j-1)-11.0/12*Psi0(i,j+1))
    ...
    !$OMP END DO
        ...
        ! top left corner
        Psi(i,j) = 0.6*(dxx+dyy)*Omega(i,j)*DM2(i,j) + &
            (-0.6*(dxx+dyy)/dxx)*(-11.0/12*Psi0(i-1,j)-0.5*Psi0(i+1,j)-1.0/3*Psi0(i+2,j)+1.0/12*Psi0(i+3,j)) + &
            (-0.6*(dxx+dyy)/dyy)*(1.0/12*Psi0(i,j-3)-1.0/3*Psi0(i,j-2)-0.5*Psi0(i,j-1)-11.0/12*Psi0(i,j+1))
        ...
        ! top right corner
        Psi(i,j) = 0.6*(dxx+dyy)*Omega(i,j)*DM2(i,j) + &
            (-0.6*(dxx+dyy)/dxx)*(1.0/12*Psi0(i-3,j)-1.0/3*Psi0(i-2,j)-0.5*Psi0(i-1,j)-11.0/12*Psi0(i+1,j)) + &
            (-0.6*(dxx+dyy)/dyy)*(1.0/12*Psi0(i,j-3)-1.0/3*Psi0(i,j-2)-0.5*Psi0(i,j-1)-11.0/12*Psi0(i,j+1))
        ...
        Psi(i,j) = 0.6*(dxx+dyy)*Omega(i,j)*DM2(i,j) + &
            (-0.6*(dxx+dyy)/dxx)*(-11.0/12*Psi0(i-1,j)-0.5*Psi0(i+1,j)-1.0/3*Psi0(i+2,j)+1.0/12*Psi0(i+3,j)) + &
            (-0.6*(dxx+dyy)/dyy)*(-11.0/12*Psi0(i,j-1)-0.5*Psi0(i,j+1)-1.0/3*Psi0(i,j+2)+1.0/12*Psi0(i,j+3))
